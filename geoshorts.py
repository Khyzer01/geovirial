...
# YouTube API Key (replace this with your actual key in a `.env` file or Streamlit secrets)
API_KEY = st.secrets["AIzaSyDXJjwWDp4JDTwmFmjb0-atLV6Qtww28Zg"]
YOUTUBE_SEARCH_URL = "https://www.googleapis.com/youtube/v3/search"
YOUTUBE_VIDEO_URL = "https://www.googleapis.com/youtube/v3/videos"
YOUTUBE_CHANNEL_URL = "https://www.googleapis.com/youtube/v3/channels"

# Streamlit App Title
st.title("YouTube Viral Topics Tool (Map Animation Shorts)")

# Input Fields
days = st.number_input("Enter Days to Search (1-30):", min_value=1, max_value=30, value=5)

# Updated keywords for your niche
keywords = [
